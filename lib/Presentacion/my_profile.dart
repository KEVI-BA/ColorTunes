...
import 'package:colortunes_beta/Datos/audioPlayerServices.dart';
...
class MyProfilePage extends StatefulWidget {
  ...
  const MyProfilePage({super.key, required this.user, required this.song});
...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  Future<void> _getFollowingCount() async {
    try {
      ...
      debugPrint("Error al obtener seguidos: $e");
      setState(() {
        _followingCount = 0;
      });
    }
